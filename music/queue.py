...
import asyncio
import time
from sigma.core.utilities.data_processing import search_youtube
        ...
        if args:
            ...
            if q.empty():
                ...
                if message.guild.id in cmd.bot.music.repeaters:
                    ...
                    embed.set_footer(text=f'To see the currently playing song type {cmd.bot.get_prefix(message)}np')
                await message.channel.send(None, embed=embed)
